...
class AutomatedPlayerTest {
  ...
  public void testReportDamage() {
    ...
    Coord successShot1 = new Coord(1, 0, CoordinateStatus.HIT, 50);
    Coord successShot2 = new Coord(2, 0, CoordinateStatus.HIT, 50);
    Coord successShot3 = new Coord(3, 0, CoordinateStatus.HIT, 50);
    Coord missShot1 = new Coord(5, 5, CoordinateStatus.HIT, 50);
    ...
    Coord[][] board = data.getOwnBoard();

    assertEquals(board[0][1].getStatus().toString(), "H");
    assertEquals(board[0][2].getStatus().toString(), "H");
    assertEquals(board[0][3].getStatus().toString(), "H");
    assertEquals(board[5][5].getStatus().toString(), "M");
  }
  ...
  public void testSuccessfulHits() {
    ...
    Coord[][] board = data.getOpponentBoard();

    assertEquals(board[0][1].getStatus().toString(), "H");
    assertEquals(board[0][2].getStatus().toString(), "H");
    assertEquals(board[0][3].getStatus().toString(), "H");
    assertEquals(board[5][5].getStatus().toString(), "H");
  }
